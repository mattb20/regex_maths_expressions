...
describe String do
  describe '#objectify' do
    ...
    #   end
    #
    #   it 'objectifies \frac{2a+3}{4+5(b+d)}' do
    #     input = '\frac{21a+3}{4-(b+d)}'
    #     expected_output = div(add(mtp(21,'a'),3),add(4,mtp(-1,add('b','d'))))
    #     expect(input.objectify).to eq expected_output
    #   end
    # end
    #
    # xcontext 'BONUS FEATURE - POWER' do
    ...
    #   end
    #
    #   it 'objectify some monstrocity' do
    #     input = '3(x+\frac{3\frac{3}{x}+5}{4+5+a})+4'
    #     expected_output = add(mtp(3,add('x',div(add(mtp(3,div(3,'x')),5),
    #       add(4,5,'a')))),4)
    #     expect(input.objectify).to eq expected_output
    #   end
    # end
